...
class TestIdPrefix:
    def test_matek_prefix(self):
        assert _id_prefix_from_source("M8_2025_1_fl.pdf", "matek") == "mat4_2025_1"

    def test_magyar_prefix(self):
        assert _id_prefix_from_source("A8_2024_2_fl.pdf", "magyar") == "mag4_2024_2"

    def test_4osztaly_prefix(self):
        assert _id_prefix_from_source("M4_2025_1_fl.pdf", "matek") == "mat8_2025_1"
...
class TestParseFilenameMeta:
    ...
    def test_magyar_utmutato(self):
        ...
        assert m == {"ev": 2024, "valtozat": 2, "kind": "ut", "targy": "magyar", "szint": "4 osztályos"}
    ...
    def test_6osztaly_feladatlap(self):
        m = parse_filename_meta("M6_2025_1_fl.pdf")
        assert m == {"ev": 2025, "valtozat": 1, "kind": "fl", "targy": "matek", "szint": "6 osztályos"}
